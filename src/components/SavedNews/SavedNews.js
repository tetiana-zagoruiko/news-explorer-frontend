          ...
          <li className="news__item">
            <div className="news__image">
              <div className="news__image-elements">
                <div className="news__keyword-area"><p className="news__keyword">Nature</p></div>
                <button className="news__delete"><div className="news__remove-text-area"><p className="news__remove-text">Remove from saved</p></div></button>
              </div>
            </div>
